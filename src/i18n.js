...
export const translations = {
  en: {
    ...
    summary: {
      ...
      how: "How this summary is made", explanation: "Categories are inferred conservatively from the foreground application and, only when useful, its window title. No screenshots, audio, or typed content.",
    ...
    overview: {
      ...
      focusTitle: "Where the day went", focusSubtitle: "Conservative categories; observed duration only", appsTitle: "Top applications", appsSubtitle: "Observed foreground time",
  ...
  ru: {
    ...
    summary: {
      ...
      how: "Как формируется итог", explanation: "Категории определяются осторожно по активному приложению и только при необходимости по заголовку окна. Без скриншотов, аудио и содержимого ввода.",
    ...
    overview: {
      ...
      focusTitle: "На что ушёл день", focusSubtitle: "Осторожная классификация; только наблюдаемое время", appsTitle: "Главные приложения", appsSubtitle: "Наблюдаемое время активного окна",
