...
export const translations = {
  en: {
    ...
    intent: {
      ...
      reasons: { "custom-rule": "Your local rule", "window-title": "Clear words in the active title", application: "Application signal", "sequence-context": "Surrounding activity", "conflicting-title-signals": "Conflicting signals", "insufficient-evidence": "Not enough evidence", insufficient: "Not enough evidence" },
    },
    summary: {
      ...
      how: "How this summary is made", explanation: "Purpose is inferred from the active app, title evidence, surrounding activity, and your local rules. Ambiguous browser and messenger time stays unknown instead of being guessed.",
    ...
    overview: {
      ...
      focusTitle: "Activity types", focusSubtitle: "What kind of application was active", intentTitle: "How the time was used", intentSubtitle: "Evidence-based purpose; unknown stays unknown", appsTitle: "Top applications", appsSubtitle: "Observed foreground time",
    ...
    settings: {
      ...
      titles: "Window titles", titlesText: "Adds the active document, tab, or chat name; never reads its contents", inputs: "Anonymous activity samples", inputsText: "Samples whether keyboard or mouse was used once per second; never records keys, coordinates, or typed text", tabs: "Browser tab count", tabsText: "Samples only the number of visible browser tabs once per minute",
      analysis: "Local purpose analysis", analysisText: "Daytrace uses clear title words and surrounding activity, but a browser or messenger can mean anything. Add a local rule for a chat, site title, project, or keyword that you know.", rulePlaceholder: "For example: Project Atlas or Netflix", rulePurpose: "Purpose", ruleEmpty: "No custom rules yet. Ambiguous contexts will remain “Unknown purpose”.", removeRule: "Remove rule",
  ...
  ru: {
    ...
    intent: {
      ...
      reasons: { "custom-rule": "Ваше локальное правило", "window-title": "Явные слова в активном заголовке", application: "Сигнал приложения", "sequence-context": "Соседняя активность", "conflicting-title-signals": "Противоречивые сигналы", "insufficient-evidence": "Недостаточно данных", insufficient: "Недостаточно данных" },
    },
    summary: {
      ...
      how: "Как формируется итог", explanation: "Цель определяется по активному приложению, явным словам в заголовке, соседней активности и вашим локальным правилам. Неоднозначное время в браузере и мессенджерах остаётся неопределённым, а не угадывается.",
    ...
    overview: {
      ...
      focusTitle: "Типы активности", focusSubtitle: "Какое приложение было активно", intentTitle: "Как использовалось время", intentSubtitle: "Цель по подтверждённым сигналам; неизвестное не угадывается", appsTitle: "Главные приложения", appsSubtitle: "Наблюдаемое время активного окна",
    ...
    settings: {
      ...
      titles: "Названия окон", titlesText: "Добавляет название активного документа, вкладки или чата, но не читает содержимое", inputs: "Обезличенный сигнал активности", inputsText: "Не чаще раза в секунду отмечает сам факт работы с клавиатурой или мышью; не записывает клавиши, координаты и введённый текст", tabs: "Число вкладок браузера", tabsText: "Раз в минуту считывает только количество видимых вкладок браузера",
      analysis: "Локальный анализ цели", analysisText: "Daytrace учитывает явные слова в заголовке и соседнюю активность, но браузер или мессенджер могут означать что угодно. Добавьте локальное правило для знакомого чата, сайта, проекта или ключевого слова.", rulePlaceholder: "Например: Проект Атлас или Netflix", rulePurpose: "Цель", ruleEmpty: "Пользовательских правил пока нет. Неоднозначный контекст останется в категории «Цель не определена».", removeRule: "Удалить правило",
