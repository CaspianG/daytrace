...
contextBridge.exposeInMainWorld("daytrace", {
  ...
  setTheme: (theme) => ipcRenderer.invoke("daytrace:set-theme", theme),
  ...
  completeOnboarding: (selection) => ipcRenderer.invoke("daytrace:complete-onboarding", selection),
  restartOnboarding: () => ipcRenderer.invoke("daytrace:restart-onboarding"),
  completeQuickTour: () => ipcRenderer.invoke("daytrace:complete-quick-tour"),
  acknowledgeReviewGuidance: (action) => ipcRenderer.invoke("daytrace:acknowledge-review-guidance", action),
  ...
  refreshAnalysisQuality: () => ipcRenderer.invoke("daytrace:refresh-analysis-quality"),
