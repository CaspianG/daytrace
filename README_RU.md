...
<p align="center"><strong>Текущий релиз: v0.5.0</strong> — версии для Windows и macOS собираются из одного тега и публикуются одновременно.</p>

<p align="center">
  <img alt="Текущая версия v0.5.0" src="https://img.shields.io/badge/current-v0.5.0-6f8f67?style=flat-square">
...
- **Адаптивный локальный анализ цели** для популярных видео-, стриминговых, социальных, торговых, учебных, рабочих, офисных, творческих и коммуникационных сценариев с уверенностью и причиной каждого вывода.
...
Длительность — это наблюдаемые интервалы активного окна, а не время, когда приложение просто оставалось открытым. Повторяющиеся события заголовка объединяются, фрагменты короче секунды и системные окна игнорируются, а обзор считает категорию каждой активности отдельно. Классификатор сочетает взвешенную семантику на русском и английском со знанием сервисов и специализированных программ, затем разбирает непрозрачные интервалы по повторяющемуся и соседнему локальному контексту. Противоречия остаются видимыми и не затираются стереотипом по приложению.
