...
<p align="center"><strong>Текущий релиз: v0.4.1</strong> — версии для Windows и macOS собираются из одного тега и публикуются одновременно.</p>

<p align="center">
  <img alt="Текущая версия v0.4.1" src="https://img.shields.io/badge/current-v0.4.1-6f8f67?style=flat-square">
...
Обновления — единственный встроенный сетевой контур. Daytrace запрашивает `api.github.com/repos/CaspianG/daytrace/releases/latest` и указывает `Daytrace/<установленная версия>` в user agent. События журнала, заголовки, вопросы, правила и настройки не передаются. Приложение принимает только точный ожидаемый артефакт из официального репозитория и перед открытием сверяет опубликованный GitHub SHA-256.
